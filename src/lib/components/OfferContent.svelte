<script lang="ts">
    import OfferModal from "./OfferPopup.svelte";
...
<span class="offerCardParent" bind:offsetWidth>
    <button class="reactiveButton" on:click={showModal}>
...
<style>
  ...
  body.disable-focus-styles ::after {
    ...
    *,
    ...
    /*! CSS Used from: /fonts/fonts-th.css */
